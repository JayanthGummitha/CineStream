  ...
  useEffect(() => {
    ...
    async function fetchKidsMovieData() {
      try {
        ...
        const accessResult = canAccessContent(movieData.id, movieData.contentRating || 'G', movieData.genres);
        ...
        getMovieTrailer(resolvedParams.id)
          ...
          .catch(err => {
            console.error('[Kids Page] Failed to load trailer:', err);
            if (isMounted) {
              setTrailerState({
                trailerSrc: null,
                isLoading: false,
        ...
        if (movieData.genres.length > 0) {
          ...
          if (isMounted) setRelatedKids(filtered);
        }
      } catch (error) {
                ...
                <div className="lg:col-span-2 space-y-6 text-white">
                  ...
                  <div className="flex flex-wrap items-center gap-4">
                    ...
                    <TrailerButton
                      ...
                      movieId={kidsMovie.id}
                      movieTitle={kidsMovie.title}
                      size="sm"
                    />
